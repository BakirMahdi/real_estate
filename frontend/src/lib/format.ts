...
const GOVERNORATES: { canonical: string; aliases: string[] }[] = [
  ...
  {
    canonical: "Manouba",
    aliases: ["manouba", "mannouba", "la manouba", "manubah"],
  },
  ...
  {
    canonical: "Kairouan",
    aliases: ["kairouan", "kairaouan", "kairwan", "qayrawan"],
  },
...
const DELEGATIONS: Record<string, string> = {
  ...
  "hammam el ghezaz": "Nabeul",
  "hammam ghezaz": "Nabeul",
  "hammam ghezeze": "Nabeul",
  "el maamoura": "Nabeul",
  maamoura: "Nabeul",
  tantana: "Nabeul",
  tazarka: "Nabeul",
  "barraket essahel": "Nabeul",
  "barraket sahel": "Nabeul",
  "bir bouregba": "Nabeul",
  "el mida": "Nabeul",
  somaa: "Nabeul",
  "el mrezga": "Nabeul",
  ...
  salakta: "Mahdia",
  rejiche: "Mahdia",
  "jebel el oust": "Zaghouan",
  "jebel oust": "Zaghouan",
  mcherga: "Zaghouan",
  saouef: "Zaghouan",
  "el battan": "Manouba",
  "kalaat landalous": "Ariana",
  aouina: "Tunis",
  gammarth: "Tunis",
  "ain zaghouane": "Tunis",
  "ain zaghouan": "Tunis",
